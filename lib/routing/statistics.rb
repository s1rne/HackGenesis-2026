...
module Routing
  ...
  module Statistics
    ...
    # конверсия у первого выше: 1.00 против 0.90. Нижняя граница при 95% ставит
    # их на места — 0.44 против 0.83. Именно поэтому мы сравниваем провайдеров
    # по ней, а не по наблюдаемой частоте: она штрафует за малую выборку.
